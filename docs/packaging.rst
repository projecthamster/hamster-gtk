...
``hamster-gtk``. If you stumble upon any incompatibilities or dependency issue please let us know.
If you are interested in packaging ``hamster-gtk`` for your preferred distribution or in some other
...
If for example you wanted to package ``hamster-gtk`` for ``debian-stable``, it would be mighty convenient to
